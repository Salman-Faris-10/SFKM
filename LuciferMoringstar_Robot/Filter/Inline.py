...
def get_reply_markup(query):
    buttons = [[
        InlineKeyboardButton('Support Group', url='t.me/FM_FilmMania'),
        InlineKeyboardButton('Master 😎', url='t.me/FM_Admin_owner')
        ],[
        InlineKeyboardButton('⬆️ Movies Update ⬆️', url=https://t.me/FM_Update')
        ],[
